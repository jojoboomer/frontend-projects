import { $cart, $count, $total, clearCart, removeItem } from '@/features/shoping-cart/cart-store';
import { btnClear, cart as cartStyle } from "@/features/shoping-cart/styles";
                ...
                <li key={i}>
                  <div className="item-body">
                    ...
                    <div>
                      ...
                      <span
                        className={css({ marginLeft: "8px", color: "cart.rose.400" })}
                      >
                        @ ${e.price.toFixed(2)}
                      </span>
                      <span
